...
{
    gpio_set_direction(CONFIG_TEMPLATE_MODEM_RESET_PIN, GPIO_MODE_OUTPUT);  
    //gpio_pullup_en(CONFIG_TEMPLATE_MODEM_RESET_PIN);
    gpio_set_level(CONFIG_TEMPLATE_MODEM_RESET_PIN, 0);
    ESP_LOGI(TAG, "CONFIG_TEMPLATE_MODEM_RESET_PIN 0");
    vTaskDelay(50);
    gpio_set_level(CONFIG_TEMPLATE_MODEM_RESET_PIN, 1);
    ESP_LOGI(TAG, "CONFIG_TEMPLATE_MODEM_RESET_PIN 1");
    vTaskDelay(1000);
}
